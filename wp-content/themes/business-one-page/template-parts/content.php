    ...
    if( has_post_thumbnail() ){
        if( is_single() ){ ?>
            <div class="post-thumbnail">
                <?php is_active_sidebar( 'right-sidebar' ) ? the_post_thumbnail( 'business-one-page-with-sidebar', array( 'itemprop' => 'image' ) ) : the_post_thumbnail( 'business-one-page-full', array( 'itemprop' => 'image' ) ) ; ?>
            </div>
        <?php }else{ ?>
            <a href="<?php the_permalink(); ?>" class="post-thumbnail">
                <?php is_active_sidebar( 'right-sidebar' ) ? the_post_thumbnail( 'business-one-page-cat-blog', array( 'itemprop' => 'image' ) ) : the_post_thumbnail( 'business-one-page-full', array( 'itemprop' => 'image' ) ) ;?>
            </a>
        <?php }
    } ?>
