...
$cta2_section_button_url = get_theme_mod( 'business_one_page_cta2_section_button_url' );
    ...
    if( $cta2_section_title || $cta2_section_content ) {
        $cta = '<strong class="title">' . esc_html( $cta2_section_title ) . '</strong>';        
        $cta .= wpautop( esc_html( $cta2_section_content ) );
        
        if( $cta2_section_button && $cta2_section_button_url )
        $cta .= '<a href="' . esc_url( $cta2_section_button_url ) . '" class="btn-start">' . esc_html( $cta2_section_button ) . '</a>';
    }
