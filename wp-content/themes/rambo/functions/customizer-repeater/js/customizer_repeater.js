...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
			...
			var banner_title = jQuery(this).find('.customizer-repeater-banner-title-control').val();
			var banner_sub_title = jQuery(this).find('.customizer-repeater-banner-sub-title-control').val();
			var banner_description = jQuery(this).find('.customizer-repeater-banner-description-control').val();
			var banner_call_title = jQuery(this).find('.customizer-repeater-banner-call-title-control').val();
			var banner_call_number = jQuery(this).find('.customizer-repeater-banner-call-number-control').val();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || designation !== '' || open_new_tab !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || button_text !== '' || slide_format !== '' || video_url !== '') {
                values.push({
					...
					'banner_call_title': banner_call_title,
					'banner_call_number': banner_call_number
                });
            }
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
				...
				/*Set the default value in banner title*/
                field.find('.customizer-repeater-banner-title-control').val('');
				
				/*Set the default value in banner sub title*/
                field.find('.customizer-repeater-banner-sub-title-control').val('');
				
				/*Set the default value in banner description*/
                field.find('.customizer-repeater-banner-description-control').val('');
				
				/*Set the default value in banner call title*/
                field.find('.customizer-repeater-banner-call-title-control').val('');
				
				
				/*Set the default value in banner call number*/
                field.find('.customizer-repeater-banner-call-number-control').val('');
	...
	theme_conrols.on('keyup','.customizer-repeater-banner-title-control', function(){
		
		customizer_repeater_refresh_general_control_values();
	});
	
	theme_conrols.on('keyup','.customizer-repeater-banner-sub-title-control', function(){
		
		customizer_repeater_refresh_general_control_values();
	});
	
	theme_conrols.on('keyup','.customizer-repeater-banner-description-control', function(){
		
		customizer_repeater_refresh_general_control_values();
	});
	
	theme_conrols.on('keyup','.customizer-repeater-banner-call-title-control', function(){
		
		customizer_repeater_refresh_general_control_values();
	});
	
	theme_conrols.on('keyup','.customizer-repeater-banner-call-number-control', function(){
