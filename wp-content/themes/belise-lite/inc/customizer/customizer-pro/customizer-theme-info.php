...
function belise_theme_info_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'belise_features_section', array(
	...
	// Add upsells.
	$wp_customize->add_setting( 'belise_upsell_pro_features_main', array(
		'sanitize_callback' => 'esc_html',
	) );

	$wp_customize->add_control( new Belise_Control_Upsell( $wp_customize, 'belise_upsell_pro_features_main', array(
	...
	$wp_customize->add_setting( 'belise_upsell_colors', array(
		'sanitize_callback' => 'esc_html',
		'default'           => '',
	) );

	$wp_customize->add_control( new Belise_Control_Upsell( $wp_customize, 'belise_upsell_colors', array(
				'section'      => 'colors',
				'priority'     => 1,
				'options'      => array(
					esc_html__( 'Three New Color Schemes', 'belise-lite' ),
				),
				'button_url'   => esc_url( 'https://themeisle.com/themes/belise/' ),
				// xss ok
				'button_text'  => esc_html__( 'View PRO version', 'belise-lite' ),
	...
	// Add upsells.
	$wp_customize->add_setting( 'belise_upsell_advanced', array(
		'sanitize_callback' => 'esc_html',
	) );

	$wp_customize->add_control( new Belise_Control_Upsell( $wp_customize, 'belise_upsell_advanced', array(
