...
if ( ! function_exists( 'belise_front_page_menus' ) ) {
	...
	function belise_front_page_menus() {
		...
		$default                          = current_user_can( 'edit_theme_options' ) ?
			sprintf( '<a href="' . admin_url( 'customize.php?autofocus[control]=belise_front_page_schedule_title' ) . '" class="customizer-admin-only">%s</a>',
		...
		$default                            = current_user_can( 'edit_theme_options' ) ?
			sprintf( '<a href="' . admin_url( 'customize.php?autofocus[control]=belise_front_page_schedule_content' ) . '" class="customizer-admin-only">%s</a>',
