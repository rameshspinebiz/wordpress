...
function belise_about_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'belise_about', array(
	...
	$wp_customize->add_setting( 'belise_page_editor', array(
		'default'           => $default,
		'sanitize_callback' => 'wp_kses_post',
		'transport'         => $selective_refresh ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( new Belise_Page_Editor( $wp_customize, 'belise_page_editor', array(
	...
	$wp_customize->add_setting( 'belise_feature_thumbnail', array(
		'sanitize_callback' => 'esc_url',
		'default'           => $default,
		'transport'         => $selective_refresh ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'belise_feature_thumbnail', array(
...
function belise_register_about_partials( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'belise_page_editor', array(
		'selector'        => '.front-page-content .row',
		'settings'        => 'belise_page_editor',
		'render_callback' => 'belise_about_render_callback',
	) );

	$wp_customize->selective_refresh->add_partial( 'belise_feature_thumbnail', array(
		'selector'        => '.front-page-content .row',
