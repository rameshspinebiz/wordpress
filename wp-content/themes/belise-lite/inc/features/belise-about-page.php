...
// Support content tab.
	'support_content' => array(
		...
		'third' => array(
			...
			'button_link' => esc_url( admin_url( 'themes.php?page=belise-welcome&tab=changelog&show=yes' ) ),
			'is_button' => false,
			'is_new_tab' => false,
		),
		'fourth' => array(
...
// Getting started tab
	'getting_started' => array(
		array(
			...
			'button_link' => esc_url( admin_url( 'themes.php?page=belise-welcome&tab=recommended_actions' ) ),
			'is_button' => false,
...
$belise_recomm_act_extra = array(
	array(
		'title' => esc_html__( 'Step 3 - Import the demo content', 'belise-lite' ),
		'text' => esc_html__( 'With a simple one click demo import, you can have your site ready to customize.', 'belise-lite' ),
		'button_label' => esc_html__( 'Import demo', 'belise-lite' ),
		'button_link' => esc_url( admin_url( 'themes.php?page=pt-one-click-demo-import' ) ),
		'is_button' => false,
		'recommended_actions' => false,
		'is_new_tab' => false,
	),
...
if ( class_exists( 'OCDI_Plugin' ) ) {
	array_push( $config['getting_started'], $belise_recomm_act_extra[0], $belise_recomm_act_extra[1] );
} else {
	array_push( $config['getting_started'], $belise_recomm_act_extra[1] );
}

TI_About_Page::init( apply_filters( 'belise_ti_about_filter', $config ) );
