...
function belise_menus_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'belise_front_page_menus', array(
		'priority' => 20,
	...
	/* Food sections */
	$wp_customize->add_setting( 'belise_menus_section_categories', array(
		'default' => array( 'none' ),
		'sanitize_callback' => 'belise_sanitize_multiple_select',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( new Belise_Customize_Control_Multiple_Select( $wp_customize, 'belise_menus_section_categories', array(
	...
	$wp_customize->add_setting( 'belise_front_page_schedule_title', array(
		'default'           => $default,
		'sanitize_callback' => 'belise_sanitize_text',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( 'belise_front_page_schedule_title', array(
	...
	$wp_customize->add_setting( 'belise_front_page_schedule_content', array(
		'default'        => $default,
		'sanitize_callback' => 'wp_kses_post',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( new Belise_Page_Editor( $wp_customize, 'belise_front_page_schedule_content', array(
	...
	if ( ! class_exists( 'Jetpack' ) ) {
		...
		$wp_customize->add_setting( 'belise_install_jetpack', array(
			'sanitize_callback' => 'wp_kses_post',
		) );

		$wp_customize->add_control( new Belise_Customizer_Message( $wp_customize, 'belise_install_jetpack', array(
			'section'        => 'belise_front_page_menus',
			'priority'       => 100,
...
function belise_register_menus_partials( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'belise_menus_section_categories', array(
	...
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_schedule_title', array(
	...
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_schedule_content', array(
