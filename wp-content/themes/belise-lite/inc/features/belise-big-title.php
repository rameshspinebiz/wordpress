...
function belise_big_title_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'belise_front_page_big_title', array(
		'priority' => 10,
	...
	$wp_customize->add_setting( 'belise_front_page_title', array(
		'default'        => $default,
		'sanitize_callback' => 'wp_kses_post',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );

	$wp_customize->add_control( new Belise_Page_Editor( $wp_customize, 'belise_front_page_title', array(
	...
	$wp_customize->add_setting( 'belise_front_page_button_text', array(
		'default'           => $default,
		'sanitize_callback' => 'belise_sanitize_text',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( 'belise_front_page_button_text', array(
	...
	$wp_customize->add_setting( 'belise_front_page_button_link', array(
		'default'           => $default,
		'sanitize_callback' => 'esc_url_raw',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( 'belise_front_page_button_link', array(
	...
	$wp_customize->add_setting( 'belise_front_page_image', array(
		'default'           => $default,
		'sanitize_callback' => 'esc_url',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'belise_front_page_image', array(
...
function belise_register_big_title_partials( $wp_customize ) {
	...
	// Front page title
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_title', array(
	...
	// Front page button
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_button', array(
	...
	// Front page button
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_button_link', array(
		'selector'        => '#hero .hero-btn-container',
		'settings'        => array( 'belise_front_page_button_text', 'belise_front_page_button_link' ),
		'render_callback' => 'belise_front_page_button_callback',
	) );
	...
	// Front page image
	$wp_customize->selective_refresh->add_partial( 'belise_front_page_image', array(
