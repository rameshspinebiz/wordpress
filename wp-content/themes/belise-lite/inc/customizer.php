...
function belise_customize_register( $wp_customize ) {
	...
	/* Panel */
	$wp_customize->add_panel( 'belise_front_page_panel', array(
		'priority' => 20,
	 ...
	 * ADVANCED OPTIONS
	 */
	$wp_customize->add_section( 'belise_advanced_options_section', array(
		'priority' => 190,
	...
	$wp_customize->add_setting( 'belise_contact_phone', array(
		'default'           => $default,
		'sanitize_callback' => 'belise_sanitize_text',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( 'belise_contact_phone', array(
	...
	$wp_customize->add_setting( 'belise_contact_email', array(
		'default'           => $default,
		'sanitize_callback' => 'belise_sanitize_text',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	) );
	$wp_customize->add_control( 'belise_contact_email', array(
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		$wp_customize->add_setting( 'belise_woocommerce_breadcrumb_display', array(
			'default'           => false,
			'sanitize_callback' => 'belise_sanitize_checkbox',
		) );
		$wp_customize->add_control( 'belise_woocommerce_breadcrumb_display', array(
		...
		$wp_customize->add_setting( 'belise_woocommerce_ordering_display', array(
			'default'           => false,
			'sanitize_callback' => 'belise_sanitize_checkbox',
		) );
		$wp_customize->add_control( 'belise_woocommerce_ordering_display', array(
		...
		$wp_customize->add_setting( 'belise_woocommerce_tabs_display', array(
			'default'           => false,
			'sanitize_callback' => 'belise_sanitize_checkbox',
		) );
		$wp_customize->add_control( 'belise_woocommerce_tabs_display', array(
	...
	$wp_customize->add_setting( 'belise_nova_menu_title_links', array(
		'default'           => false,
		'sanitize_callback' => 'belise_sanitize_checkbox',
	) );
	$wp_customize->add_control( 'belise_nova_menu_title_links', array(
...
function belise_register_general_partials( $wp_customize ) {
	...
	// Phone
	$wp_customize->selective_refresh->add_partial( 'belise_contact_phone', array(
	...
	// E-mail
	$wp_customize->selective_refresh->add_partial( 'belise_contact_email', array(
