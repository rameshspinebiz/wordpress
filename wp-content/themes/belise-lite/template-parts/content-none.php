		...
		<div class="page-content">
			...
			if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
				<p><?php
					...
					printf( esc_html__( 'Ready to publish your first post? %s.', 'belise-lite' ), sprintf( '<a href="%1$s">%2$s</a>', esc_url( admin_url( 'post-new.php' ) ), esc_html__( 'Get started here','belise-lite' ) ) ); ?></p>
