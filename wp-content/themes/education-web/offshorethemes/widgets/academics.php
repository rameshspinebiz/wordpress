<?php
/**
 * Academics Section Widgets
 *
 * @since Education Web 1.0.0
 *
 * @param null
 *
 * @return array $education_web_academics_column_number
 *
 */
if ( ! function_exists( 'education_web_academics_column_number' ) ) :
	function education_web_academics_column_number() {
		$education_web_academics_column_number = array(
			1 => esc_html__( '1', 'education-web' ),
			2 => esc_html__( '2', 'education-web' ),
			3 => esc_html__( '3', 'education-web' )
		);

		return apply_filters( 'education_web_academics_column_number', $education_web_academics_column_number );
	}
endif;
 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Education_web_academics' ) ) {

	class Education_web_academics extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct(
				...
				*/
				esc_html__( 'OT : Academics', 'education-web' ),

				/**
				 * Widget description
				*/
				array( 'description' => esc_html__( 'A Widget Display Academics Courses Area', 'education-web' ), )
			);
		...
		*/
		...
		<?php if( $page_id != 0 ){ ?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select Academics Pages', 'education-web' ); ?>:</label>
                    <br/>
                    <small><?php esc_html_e( 'Select Academics Pages', 'education-web' ); ?></small>
					<?php
						...
						$args = array(
							...
							'class'            => 'widefat',
							'show_option_none' => esc_html__( 'Select Academics Pages', 'education-web' ),
			...
			<?php } else{ ?>
                ...
                <label><?php esc_html_e( 'Select Academics Pages', 'education-web' ); ?>:</label>
                <div class="sp-repeater">
	                            ...
	                            <div class="repeater-table">
	                                ...
	                                <div class="sp-repeater-top">
	                                    ...
	                                    <div class="sp-repeater-title">
	                                        <h3><?php esc_html_e( 'Select Academics Page Item', 'education-web' )?><span class="in-sp-repeater-title"></span></h3>
	                                    </div>
	                                </div>
	                    ...
	                    <script type="text/html" class="sp-code-for-repeater">
	                        <div class="repeater-table">
	                            <div class="sp-repeater-top">
	                                ...
	                                <div class="sp-repeater-title">
	                                    <h3><?php esc_html_e( 'Academics Page Item', 'education-web' )?><span class="in-sp-repeater-title"></span></h3>
	                                </div>
	                            </div>
	                            <div class='sp-repeater-inside hidden'>
									<?php
					...
					<?php
						...
						$add_field = esc_html__('Academics Page Item', 'education-web');
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'column_number' ) ); ?>">
					<?php
						$education_web_academics_column_numbers = education_web_academics_column_number();
						foreach ( $education_web_academics_column_numbers as $key => $value ) {
					?>
		...
		?>
			...
			<section id="academics" class="edu-widget">
				<div class="container">				
					<?php
						/**
					...
					<div class="row">
                        ...
                        if( !empty( $education_web_child_page_args ) ){
							...
							$academic = new WP_Query( $education_web_child_page_args );
							...
							if( 1 == $column_number ){
                                $init_column_content .= " col-sm-12";
                            }
                            elseif( 2 == $column_number ){
                                $init_column_content .= " col-sm-6 col-xs-12";
                            }
                            elseif( 3 == $column_number ){
                                $init_column_content .= " col-md-4 col-sm-6 col-xs-12";
                            }
                            else{
                                $init_column_content .= " col-md-4 col-sm-6 col-xs-12";
                            }
						?>
							<div class="<?php echo esc_attr( $init_column_content ); ?>">
							    <div class="academics-item">
							        ...
							        <div class="edu-text">
								        <h3><?php the_title(); ?></h3>
								        <p><?php echo esc_attr( wp_trim_words( get_the_content(), 18 ) ); ?></p>
	...
	} // Class Education_web_academics ends here
}
 ...
 *
 */
if ( ! function_exists( 'Education_web_academics' ) ) :

	function Education_web_academics() {
		register_widget( 'Education_web_academics' );
	}

endif;
add_action( 'widgets_init', 'Education_web_academics' );