 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Education_web_faq' ) ) {

	class Education_web_faq extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct(
				...
				*/
				esc_html__( 'OT : FAQ Section', 'education-web' ),

				/**
				 * Widget description
				*/
				array( 'description' => esc_html__( 'A Widget Display Company FAQ Services Section', 'education-web' ), )
			);
		...
		*/
		...
		<?php if( $page_id != 0 ){ ?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select FAQ Pages', 'education-web' ); ?>:</label>
                    <br/>
                    <small><?php esc_html_e( 'Select FAQ Pages', 'education-web' ); ?></small>
					<?php
						...
						$args = array(
							...
							'class'            => 'widefat',
							'show_option_none' => esc_html__( 'Select FAQ Pages', 'education-web' ),
			...
			<?php } else{ ?>
                ...
                <label><?php esc_html_e( 'Select FAQ Pages', 'education-web' ); ?>:</label>
                <div class="sp-repeater">
	                            ...
	                            <div class="repeater-table">
	                                ...
	                                <div class="sp-repeater-top">
	                                    ...
	                                    <div class="sp-repeater-title">
	                                        <h3><?php esc_html_e( 'Select FAQ Page Item', 'education-web' )?><span class="in-sp-repeater-title"></span></h3>
	                                    </div>
	                                </div>
	                    ...
	                    <script type="text/html" class="sp-code-for-repeater">
	                        <div class="repeater-table">
	                            <div class="sp-repeater-top">
	                                ...
	                                <div class="sp-repeater-title">
	                                    <h3><?php esc_html_e( 'FAQ Page Item', 'education-web' )?><span class="in-sp-repeater-title"></span></h3>
	                                </div>
	                            </div>
	                            <div class='sp-repeater-inside hidden'>
									<?php
					...
					<?php
						...
						$add_field = esc_html__('FAQ Page Item', 'education-web');
		...
		?>
			...
			<section id="faq" class="faq edu-widget">
				<div class="container">
					<?php
						/**
					...
					<div class="row">
						<div class="col-md-7 col-sm-12 col-xs-12">
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		                        ...
		                        if( !empty( $education_web_child_page_args ) ){
									...
									$faqpage = new WP_Query( $education_web_child_page_args );
						...
						<?php if( !empty( $featuresimg ) ){ ?>
							<div class="col-md-5">
								<div class="faq-image">
									<img src="<?php echo esc_url( $featuresimg ); ?>" alt="<?php esc_html_e( 'Faq Image preview', 'education-web' ); ?>">
								</div>
							</div>
						<?php } ?>
					</div>
	...
	} // Class Education_web_faq ends here
}
 ...
 *
 */
if ( ! function_exists( 'Education_web_faq' ) ) :

	function Education_web_faq() {
		register_widget( 'Education_web_faq' );
	}

endif;
add_action( 'widgets_init', 'Education_web_faq' );