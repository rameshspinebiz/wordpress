...
<div class="container">
	<div class="row">
		<?php
	    $layout_settings = get_theme_mod( 'tameer_construction_layout_settings', __('Right Sidebar','tameer-construction') );
			...
			<div class="col-lg-8 col-md-8">
				...
				while ( have_posts() ) : the_post(); 
					...
					the_post_navigation( array(
						'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'tameer-construction' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'tameer-construction' ) . '</span>',
						'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'tameer-construction' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'tameer-construction' ) . '</span>',
					) );
