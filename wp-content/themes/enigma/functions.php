	...
	function weblizar_default_settings()
{
	...
	$ImageUrl7 = esc_url(get_template_directory_uri() ."/images/portfolio4.png");
		$ImageUrl8 = esc_url(get_template_directory_uri() ."/images/banner04.jpg");
		$ImageUrl9 = esc_url(get_template_directory_uri() ."/images/banner05.jpg");
		$ImageUrl0 = esc_url(get_template_directory_uri() ."/images/banner06.jpg");
		$ImageUrl1 = esc_url(get_template_directory_uri() ."/images/banner07.jpg");
	$wl_theme_options=array(
			...
			'slide_title_2' => __('Slide Title', 'enigma' ),
			'slide_desc_2' => __('Lorem Ipsum is simply dummy text of the printing', 'enigma' ),
			'slide_btn_text_2' => __('Read More', 'enigma' ),
			'slide_btn_link_2' => '#',
			'slide_image_3' => $ImageUrl3,
			'slide_title_3' => __('Slide Title ', 'enigma' ),
			'slide_desc_3' => __('Lorem Ipsum is simply dummy text of the printing', 'enigma' ),
			'slide_btn_text_3' => __('Read More', 'enigma' ),
			'slide_btn_link_3' => '#',
		'slide_image_4' => $ImageUrl8,
			'slide_btn_text_4' => __('Read More', 'enigma' ),
			'slide_btn_link_4' => '#',
		'slide_image_5' => $ImageUrl9,
			'slide_btn_text_5' => __('Read More', 'enigma' ),
			'slide_btn_link_5' => '#',
		'slide_image_6' => $ImageUrl0,
			'slide_btn_text_6' => __('Read More', 'enigma' ),
			'slide_btn_link_6' => '#',
		'slide_image_7' => $ImageUrl1,
			'slide_btn_text_7' => __('Read More', 'enigma' ),
			'slide_btn_link_7' => '#',
			'slider_anim'=>'',
			'animate_type_title'=>'',
			'animate_type_desc'=>'',
