...
class Perth_Action extends WP_Widget {

    function perth_action() {
		$widget_ops = array('classname' => 'perth_action_widget', 'description' => __( 'Display a call to action block.', 'perth') );
        parent::__construct(false, $name = __('Perth FP: Call to action', 'perth'), $widget_ops);
	...
	?>
	<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'perth'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'perth'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'perth'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'perth'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'perth' ); ?></label></p>
	<?php
	}
...
?>
        <div class="call-to-action <?php echo $aside_style; ?>">
			<div class="promo-wrap">
				...
				<div class="action-button">
					<a href="<?php echo esc_url($action_btn_link); ?>" class="button more-button"><?php echo esc_html($action_btn_text); ?></a>
				</div>
			</div>
        </div>
	<?php
