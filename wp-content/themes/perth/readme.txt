...
Perth, Copyright 2015 
Perth is licensed under GNU General Public License V2 or later. You can find a copy of it in the license.txt file.
...
c) Icons
The icon set used in Perth is FontAwesome.
...
h1)
Copyright: Unsplash
Resource URI: https://pixabay.com/en/tie-necktie-adjust-adjusting-man-690084/
License: CC0 1.0
License URI: http://creativecommons.org/publicdomain/zero/1.0/deed.en

h2)
Copyright: Unsplash
Resource URI: https://pixabay.com/en/city-street-urban-town-road-731296/
License: CC0 1.0
License URI: http://creativecommons.org/publicdomain/zero/1.0/deed.en
...
Theme documentation is available on http://athemes.com/documentation/perth/